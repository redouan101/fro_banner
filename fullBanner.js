...
let redouan   = document.querySelector('.fb_redouan');
...
// de classes delete uit css//
const animeren = () => {
    setTimeout( () => {wat.classList.remove('fb--uit')}, 1);
    setTimeout( () => {redouan.classList.remove('fb--uit')}, 300);
...
//banner linken//
const gaNaarPagina = () => window.open('http://www.wall.redouan.nl', '_blank');
